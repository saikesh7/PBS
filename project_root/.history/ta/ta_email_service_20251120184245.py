...
def send_new_request_email(validator_email, validator_name, employee_name, category_name, points, event_date, notes):
    ...
    content = f"""
    <table width="100%" cellpadding="0" cellspacing="0" style="background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%); border-radius: 12px 12px 0 0;">
        <tr>
    ...
    <div style="padding: 35px; background: #ffffff;">
        ...
        <p style="font-size: 15px; color: #4b5563; line-height: 1.6; margin-top: 25px;">Please review and take action on this request at your earliest convenience.</p>
            ...
            <a href="https://pbs.prowesssoft.com/auth/login" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%); color: white; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 16px; box-shadow: 0 8px 30px rgba(59,130,246,0.25);">Login to Review Request</a>
        </p>
    </div>
    """
...
def send_bulk_request_email(validator_email, validator_name, request_count, updater_name):
    ...
    <div style="padding: 35px; background: #ffffff;">
        ...
        <p style="text-align: center; margin-top: 35px;">
            <a href="https://pbs.prowesssoft.com/auth/login" style="display: inline-block; padding: 16px 40px; background: linear-gradient(135deg, #3b82f6 0%, #1e40af 100%); color: white; text-decoration: none; border-radius: 10px; font-weight: 700; font-size: 16px; box-shadow: 0 8px 30px rgba(59,130,246,0.25);">Login to Review Requests</a>
        </p>
    </div>
    """
