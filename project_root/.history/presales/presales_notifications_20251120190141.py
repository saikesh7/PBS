"""
Presales Notifications Module
Email notifications for presales requests (approval, rejection, new requests)
"""
import smtplib
...
def send_approval_notification(request_data, employee, validator, category):
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>Presales Points Approved</h2>
            ...
            <div class="content">
                ...
                <p>Great news! Your presales points request has been approved and the points have been credited to your account.</p>
...
Your presales points request for '{template_vars['category_name']}' has been approved.
...
"""
    ...
    return send_email_notification(
        employee.get('email'),
        employee.get('name'),
        "Presales Points Request Approved",
        html_content,
        text_content
    )
...
def send_rejection_notification(request_data, employee, validator, category):
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>Presales Points Rejected</h2>
                <p style="margin: 5px 0 0 0; font-size: 14px; opacity: 0.95;">Request has been rejected by validator</p>
            </div>
            <div class="content">
                <p>Hello <strong>{{ employee_name }}</strong>,</p>
                <p>Your presales points request has been rejected by the validator. Please review the details below.</p>
...
Your presales points request for '{template_vars['category_name']}' has been rejected.
...
"""
    ...
    return send_email_notification(
        employee.get('email'),
        employee.get('name'),
        "Presales Points Request Rejected",
        html_content,
        text_content
    )

def send_new_request_notification(request_data, employee, validator, category):
    """Send notification to validator about new presales request"""
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>New Presales Points Request for Validation</h2>
            </div>
            <div class="content">
                <p>Dear {{ validator_name }},</p>
                <p>You have received a new presales points request that requires your validation:</p>
    ...
    return send_email_notification(
        validator.get('email'),
        validator.get('name'),
        f"New Presales Points Request from {employee.get('name')}",
        html_content
    )
