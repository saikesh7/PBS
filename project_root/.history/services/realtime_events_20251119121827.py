...
def publish_request_raised(request_data: Dict, employee_data: Dict, validator_data: Dict, category_data: Dict):
    ...
    try:
        ...
        elif dashboard_type in ['ta_up', 'ta_va'] or 'ta_va' in validator_access or dashboard_type.startswith('ta'):
            # For TA Validator, use 'new_request' event
            # Handles both TA updater-created and employee-raised TA requests
            event_type = 'new_request'
