...
def get_top_performers(start_date, end_date, limit=10, department=None, grade=None, scope='organization', dp_user_id=None):
    ...
    print(f"DEBUG get_top_performers: start_date={start_date}, end_date={end_date}, department={department}, grade={grade}, scope={scope}")
    ...
    if scope == 'my_team' and dp_user_id:
        ...
        print(f"DEBUG: My team has {len(allowed_user_ids)} employees")
