...
def validator_dashboard():
    ...
    try:
        ...
        # Fetch ALL pending requests assigned to this validator (including employee_raised categories)
        # Don't filter by category_ids - validator should see all requests assigned to them
        ...
        # Fetch ALL records assigned to this validator (including employee_raised categories)
        ...
        # Fetch ALL records awarded by this validator (including employee_raised categories)
    ...
    for request_id_str in selected_request_ids:
        try:
            ...
            points_record = {
                ...
                "award_date": request_doc.get("event_date", datetime.utcnow()),
                "awarded_by": ObjectId(user['_id']),
                "notes": "Bulk approved by PMO Validator",
                "request_id": request_id,
                "created_at": datetime.utcnow()
            }
            mongo.db.points.insert_one(points_record)
...
def get_pending_count():
    ...
    try:
        ...
        # Count ALL pending requests assigned to this validator (including employee_raised categories)
