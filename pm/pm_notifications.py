"""
PM Notifications Module
Email notifications for PM requests (approval, rejection, new requests)
"""
import smtplib
...
def send_email_notification(to_email, to_name, subject, html_content, text_content=None):
    ...
    try:
        ...
        msg['Message-ID'] = smtplib.quoteaddr(f"<{datetime.now().timestamp()}@prowesssoft.com>")
        msg['Date'] = datetime.now().strftime('%a, %d %b %Y %H:%M:%S %z')
        msg['X-Mailer'] = 'Prowess Points System v1.0'
        msg['Precedence'] = 'bulk'
        msg['Importance'] = 'high'
        msg['X-Priority'] = '1'
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Great news! Your PM points request has been approved and the points have been credited to your account.</p>
...
Your points request for '{template_vars['category_name']}' has been approved.
...
def send_rejection_notification(request_data, employee, validator, category):
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>PM Points Rejected</h2>
                <p style="margin: 5px 0 0 0; font-size: 14px; opacity: 0.95;">Request has been rejected by validator</p>
            </div>
            <div class="content">
                <p>Hello <strong>{{ employee_name }}</strong>,</p>
                <p>Your PM points request has been rejected by the validator. Please review the details below.</p>
...
Your points request for '{template_vars['category_name']}' has been rejected.
...
def send_new_request_notification(request_data, employee, validator, category):
    """Send notification to validator about new request"""
    ...
    <body>
        <div class="container">
            <div class="header">
                <h2>New Points Request for Validation</h2>
            </div>
            <div class="content">
    ...
    return send_email_notification(
        validator.get('email'),
        validator.get('name'),
        f"New Points Request from {employee.get('name')}",
        html_content
    )
