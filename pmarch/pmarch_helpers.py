...
def get_pmarch_categories():
    """
    Get all ACTIVE PM/Arch categories from hr_categories collection
...
def get_pmarch_category_ids():
    """Get list of ACTIVE PM/Arch category ObjectIds - for new requests"""
    categories = get_pmarch_categories()
    return [cat["_id"] for cat in categories]


def get_all_pmarch_categories():
    """
    Get ALL PM/Arch categories (both active and inactive) from hr_categories collection
...
def get_all_pmarch_category_ids():
    """Get list of ALL PM/Arch category ObjectIds (active + inactive) - for displaying existing requests"""
    categories = get_all_pmarch_categories()
    return [cat["_id"] for cat in categories]
