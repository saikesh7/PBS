...
ERROR_MESSAGES = {
    ...
    'CATEGORIES_NOT_FOUND': 'PM/Arch categories not found. Please contact HR.',
...
# PM/Arch Category Codes - REMOVED: Now fetched dynamically from hr_categories
# Categories are fetched using get_pmarch_categories() helper function
