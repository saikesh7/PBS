    ...
    try:
        ...
        for req in approved_requests:
            ...
            if is_bonus:
                ...
                total_regular_points += points
            
            # ✅ FIXED: Only count regular points in quarterly/yearly (exclude bonus)
            if not is_bonus:
        ...
        # ✅ FIXED: Total = Regular only (bonus shown separately)
        ...
        return jsonify({
            ...
            'regular_points': total_regular_points,
    ...
    try:
        ...
        for req in newly_processed_requests:
            ...
            if req['status'] == 'Approved':
                ...
                # ✅ DO NOT send rejection email notifications to employees
                # Rejections are handled in-app only, no email needed
                pass
